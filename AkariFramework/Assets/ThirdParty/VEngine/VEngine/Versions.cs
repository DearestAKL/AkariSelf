...
namespace VEngine
{
    ...
    public static class Versions
    {
        ...
        public static GetDownloadSize GetDownloadSizeAsync(GetDownloadSizeMode mode, params string[] items)
        {
        ...
        public static List<BundleInfo> GetBundlesWithAssets(string[] assetNames)
        {
